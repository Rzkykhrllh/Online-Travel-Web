            ...
            <div class="container">
                <div class="section-popular-travel row justify-content-center">
                    <div class="col-sm6 col md-4 col-lg-3">
                        ...
                        style="background-image: url('frontend/images/loc1.jpg');">
                    ...
                    <div class="col-sm6 col md-4 col-lg-3">
                        <div class="card-travel text-center d-flex flex-column"
                        style="background-image: url('frontend/images/loc2.jpg');">
                            <div class="travel-country">
                                INDONESIA
                            </div>
                            <div class="travel-location">
                    ...
                    <div class="col-sm6 col md-4 col-lg-3">
                        <div class="card-travel text-center d-flex flex-column"
                        style="background-image: url('frontend/images/loc3.jpg');">
                            <div class="travel-country">
                                INDONESIA
                            </div>
                            <div class="travel-location">
                    ...
                    <div class="col-sm6 col md-4 col-lg-3">
                        <div class="card-travel text-center d-flex flex-column"
                        style="background-image: url('frontend/images/loc4.jpg');">
                            <div class="travel-country">
                                UAE
                            </div>
                            <div class="travel-location">
